...
public class CubeAnimation extends ViewPropertyAnimation {
    ...
    org.hugoandrade.calendarviewapp.helpers.CubeAnimation create(@Direction int direction, boolean enter, long duration) {
        switch (direction) {
            case UP:
            case DOWN:
    ...
    private static class VerticalCubeAnimation extends org.hugoandrade.calendarviewapp.helpers.CubeAnimation {
    ...
    private static class HorizontalCubeAnimation extends org.hugoandrade.calendarviewapp.helpers.CubeAnimation {
