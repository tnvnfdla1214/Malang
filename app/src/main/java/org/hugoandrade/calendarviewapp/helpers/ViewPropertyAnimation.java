...
public class ViewPropertyAnimation extends Animation {
    ...
    public org.hugoandrade.calendarviewapp.helpers.ViewPropertyAnimation fading(@FloatRange(from=0.0f,to=1.0f) float fromAlpha, @FloatRange(from=0.0f,to=1.0f) float toAlpha) {
