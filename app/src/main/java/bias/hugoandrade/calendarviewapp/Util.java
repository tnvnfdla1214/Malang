...
public class Util {                                                                                     // part18 :  중복되는 코드 빼기 (7'30")
    ...
    public static boolean isMarketStorageUrl(String URL){ return Patterns.WEB_URL.matcher(URL).matches() && URL.contains("https://firebasestorage.googleapis.com/v0/b/calendar-set-a387a.appspot.com/o/USER"); }
